...
import { CAMPAIGN_BY_ID, DELETE_CONTACT, GET_CONTACTS, GET_GROUP_MEMBER_CONTACTS } from "graphql/queries";
import { useRouter } from "next/router";

const DeleteGroupMemberContactModal = ({ contact }) => {
...
export default DeleteGroupMemberContactModal;
