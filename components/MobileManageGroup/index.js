...
import GroupMemberContactsList from "../GroupMemberContactsList";
              ...
              >
                ...
                >
                  <Box>
                    ...
                    <Box my=".5rem">
                      <Box fontSize=".875" fontWeight="600">
                        <NextLink href={`/campaign/${data.findGroupMemberByID.campaign._id}`}>
                  ...
                  <Box fontSize=".875" fontWeight="400">
                    You Have Raised: ${data.findGroupMemberByID.amountRaised}
                  </Box>
                  <Box fontSize=".875" fontWeight="400">
                    Total Raised: ${data.findGroupMemberByID.campaign.amountRaised}
                  </Box>
                </Box>
              </Box>
            </Box>
                  ...
                  <h2>
                    <AccordionButton>
                      <Box flex="1" textAlign="left">
                        Donors ({data.findGroupMemberByID.donors.data.length})
                      </Box>
                      <AccordionIcon />
                    </AccordionButton>
                  </h2>
                  <AccordionPanel pb={4}>
                    {data.findGroupMemberByID.donors.data.map((donor) => {
                      return (
                        <Box
                          key={donor._id}
                          _before={{ display: "table", content: '""' }}
